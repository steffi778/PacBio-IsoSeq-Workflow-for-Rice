...
# Output
my_output <- paste("figures/","2_busco_tama.png",sep="/") 
my_width <- 20
my_height <- 15
my_unit <- "cm"
...
my_percentage <- c(50.2, 15.1, 3.0, 31.7, 52.3, 12.6, 4.0, 31.1, 32.6, 8.6, 5.1, 53.7, 42.6, 6.7, 3.7, 47.0, 54.4, 15.3, 2.8, 27.5, 49.5, 17.4, 2.1, 31.0, 51.6, 14.7, 2.3, 31.4, 48.1, 16.7, 3.7, 31.5,  52.8, 15.3, 2.1, 29.8, 45.1, 11.9, 4.2, 38.8)
my_values <- c(216, 65, 13, 136, 225, 54, 17, 134, 140, 37, 22, 231, 183, 29, 16, 202, 234, 66, 12, 118, 213, 75, 9, 133, 222, 63, 10, 135, 207, 72, 16, 135, 227, 66, 9, 128, 194, 51, 18, 167)
