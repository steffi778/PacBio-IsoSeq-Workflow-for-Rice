...
# Output
my_output <- paste("figures/","3_busco_cogent.png",sep="/") 
my_width <- 20
my_height <- 15
my_unit <- "cm"
...
# Legend
my_title <- "BUSCO cogent (collapsed)"
...
my_species <- c('Nipponbare', 'Nipponbare', 'Nipponbare', 'Nipponbare', 'N22', 'N22', 'N22', 'N22', 'Dular', 'Dular', 'Dular', 'Dular', 'Anjali', 
                'Anjali', 'Anjali', 'Anjali', 'CT9993-5-10-1M', 'CT9993-5-10-1M', 'CT9993-5-10-1M', 'CT9993-5-10-1M', 'M202', 'M202', 'M202', 'M202', 'Moroberekan', 'Moroberekan', 
                'Moroberekan', 'Moroberekan', 'IR62266-42-6-2', 'IR62266-42-6-2', 'IR62266-42-6-2', 'IR62266-42-6-2', 'IR64', 'IR64', 'IR64', 'IR64', 'IR72', 'IR72', 'IR72', 'IR72')
...
my_percentage <- c(24.7, 19.5, 3.3, 52.5, 27.2, 13.7, 3.3, 55.8, 17.4, 9.3, 2.8, 70.5, 20.0, 8.1, 1.6, 70.3, 27.2, 18.6, 3.5, 50.7, 24.9, 20.0, 1.6, 53.5, 26.0, 16.5, 2.6, 54.9, 27.9, 20.2, 1.9, 50.0, 26.5, 18.1, 2.6, 52.8, 23.3, 14.2, 3.0, 59.5)
my_values <- c(106, 84, 14, 226, 117, 59, 14, 240, 75, 40, 12, 303, 86, 35, 7, 302, 117, 80, 15, 218, 107, 86, 7, 230, 112, 71, 11, 236, 120, 87, 8, 215, 114, 78, 11, 227, 100, 61, 13, 256)
